...
const clangUrl = "/cpp_worker/assets/clang.wasm";
const lldUrl = "/cpp_worker/assets/lld.wasm";
const sysrootUrl = "/cpp_worker/assets/sysroot.tar";
...
export class API {
    ...
    async getModule(name) {
        ...
        const cppModule = await this.hostLogAsync(
        ...
        this.moduleCache[name] = cppModule;
        return cppModule;
    }
